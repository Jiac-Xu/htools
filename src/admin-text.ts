...
export function getAdminMaintenanceText(locale: Locale) {
  if (locale === "zh") {
    ...
    return {
      ...
      linkCheckTab: "链接检测",
      sourceTitle: "导入",
      sourceDescription: "\u4ece\u517c\u5bb9\u7684 JSON \u8ba2\u9605\u6e90\u8bfb\u53d6\u5de5\u5177\u6570\u636e\u3002\u9ed8\u8ba4\u4f7f\u7528 HTools \u4e3b\u4ed3\u5e93\u6570\u636e\u6e90\uff0c\u4e5f\u53ef\u586b\u5199\u5176\u4ed6\u7ad9\u70b9\u516c\u5f00\u7684 /api/htools.json\u3002\u53ef\u5148\u68c0\u6d4b\u8ba2\u9605\u6e90\u5185\u5bb9\uff0c\u786e\u8ba4\u65e0\u8bef\u540e\u518d\u5bfc\u5165 D1\u3002",
      sourceUrl: "\u8ba2\u9605\u6e90 URL",
      ...
      telegramDescription: "将选中的工具或文章手动推送到配置的 Telegram 目标；请先配置下方两个环境变量，Token 和目标 ID 不会在后台显示。",
      telegramTokenLabel: "发送通知的机器人 Token",
      telegramTargetLabel: "接收通知的账户、群组或频道 ID",
      telegramAvailable: "已配置",
      telegramUnavailable: "未配置",
      telegramEnabled: "已开启",
      telegramDisabled: "已关闭",
      telegramEnable: "开启推送",
      telegramDisable: "关闭推送",
      telegramSave: "保存设置",
      telegramTest: "测试连接",
      telegramFooterLabel: "固定消息尾巴 Markdown",
      telegramFooterPlaceholder: "[频道](https://t.me/example) ｜ [聊天](https://t.me/example_group)",
      telegramNotConfigured: "尚未完整配置 TGTOKEN 和 TGID，当前无法开启或测试此功能。",
  ...
  return {
    ...
    sourceTitle: "Import",
    sourceDescription:
      "Read tools from a compatible JSON subscription source. HTools uses its main repository source by default, but you can enter another site's public /api/htools.json. Check the source first, then import it into D1 after confirming the result.",
    ...
    telegramDescription: "Manually push selected tools or articles to the configured Telegram target. Configure both variables below first; the token and target ID are never shown in admin.",
    telegramTokenLabel: "Notification bot token",
    telegramTargetLabel: "Recipient user, group, or channel ID",
    telegramAvailable: "Configured",
    telegramUnavailable: "Not configured",
    telegramEnabled: "Enabled",
    telegramDisabled: "Disabled",
    telegramEnable: "Enable Push",
    telegramDisable: "Disable Push",
    ...
    telegramNotConfigured: "TGTOKEN and TGID are incomplete, so this feature cannot be enabled or tested.",
...
export function getContentFlowText(locale: Locale) {
  if (locale === "zh") {
    return {
      ...
      feedUrlNotAllowed: "该 RSS 源地址不允许访问，请使用公开的 http/https 地址。",
  ...
  return {
    ...
    feedUrlNotAllowed: "This RSS URL is not allowed. Use a public http/https URL.",
